import { assets } from './assets.js?v=83';
import { network } from './network.js?v=83';
...
export class UIManager {
    ...
    update2v2SlotVisual(slotIndex) {
        ...
        if (thumbEl) thumbEl.src = `assets/${slot.char}/avatar.png?v=83`;
    ...
    update2v2BanVisual() {
        ...
        if (blueBan !== 'none') {
            if (thumbBlue) { thumbBlue.src = `assets/${blueBan}/avatar.png?v=83`; thumbBlue.classList.remove('hidden'); }
        ...
        if (redBan !== 'none') {
            if (thumbRed) { thumbRed.src = `assets/${redBan}/avatar.png?v=83`; thumbRed.classList.remove('hidden'); }
